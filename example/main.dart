...
Future createLineChart() async {
  ...
  charEngine2.renderLineChart(
      document.querySelector('#chartjs-line1-output') as HTMLElement, series);
  ...
  charEngine1.renderLineChart(
      ...
      series);
  charEngine2.renderLineChart(
      document.querySelector('#chartjs-line2-output') as HTMLElement, series);
}
...
Future createBarChart() async {
  ...
  charEngine1.renderBarChart(
      document.querySelector('#apexcharts-bar-output') as HTMLElement, series);
  charEngine2.renderBarChart(
      document.querySelector('#chartjs-bar-output') as HTMLElement, series);

  series.title = 'Horizontal Bar Chart Example';
  charEngine1.renderHorizontalBarChart(
      document.querySelector('#apexcharts-horizontal-bar-output')
          as HTMLElement,
      series);
...
Future createGaugeChart() async {
  ...
  charEngine1.renderGaugeChart(
      document.querySelector('#apexcharts-gauge-output') as HTMLElement, set);
  charEngine2.renderGaugeChart(
      document.querySelector('#chartjs-gauge-output') as HTMLElement, set);
}
