...
class ChartEngineChartJS extends ChartEngine {
  ...
  static final String JS_WRAPPER_GLOBAL_NAME = '__ChartEngine_Wrapper_ChartJS__' ;
  ...
  static final LoadController _loadController = LoadController('ChartEngineChartJS') ;
  ...
  /// Loads ChartJS (`chart.js`) and egine wrapper.
  @override
  Future<bool> load() {
